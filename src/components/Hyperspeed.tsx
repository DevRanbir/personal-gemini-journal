...
class App {
  ...
  constructor(container: HTMLElement, options: HyperspeedOptions) {
    ...
    // Use container dimensions for full coverage
    const width = container.offsetWidth || window.innerWidth;
    const height = Math.max(container.offsetHeight, window.innerHeight, document.documentElement.scrollHeight);
  ...
  onWindowResize() {
    ...
    const height = Math.max(this.container.offsetHeight, window.innerHeight, document.documentElement.scrollHeight);
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
  ...
  return <div id="lights" ref={hyperspeed} style={{ 
    width: '100%', 
    height: '100%', 
    minHeight: '100vh',
    overflow: 'hidden',
